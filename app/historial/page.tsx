  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      ...
      <div className="max-w-6xl mx-auto bg-white shadow-md rounded p-6 mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">Historial de Entradas</h2>
        <table className="table-auto w-full border-collapse border border-gray-300 text-base">
          ...
          <tbody>
            {historyEntradas.map((entry, index) => (
              ...
              >
                <td className="border border-gray-300 px-6 py-3 text-gray-900">{entry.name}</td>
                <td className="border border-gray-300 px-6 py-3 text-gray-900">{entry.role}</td>
                <td className="border border-gray-300 px-6 py-3 text-gray-900">{entry.plate}</td>
                <td className="border border-gray-300 px-6 py-3 text-gray-900">{entry.parking_lot}</td>
                <td className="border border-gray-300 px-6 py-3 text-gray-900">{entry.space}</td>
